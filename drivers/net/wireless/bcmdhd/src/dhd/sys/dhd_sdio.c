...
#if defined(CONFIG_SKY_EF40S_BOARD)// PZ2224_yikyu for semco murata nvram
#define MURATA_NV_PATH "/etc/wifi/nvram_murata_b2_40s.txt"
...
#if defined(DHD_DEBUG) || defined(CONFIG_SKY_EF40S_BOARD) // PZ2224_yikyu for semco murata nvram
