...
{
	rcu_assign_pointer_nonull(set_h245_addr_hook, NULL);
	rcu_assign_pointer_nonull(set_h225_addr_hook, NULL);
	rcu_assign_pointer_nonull(set_sig_addr_hook, NULL);
	rcu_assign_pointer_nonull(set_ras_addr_hook, NULL);
	rcu_assign_pointer_nonull(nat_rtp_rtcp_hook, NULL);
	rcu_assign_pointer_nonull(nat_t120_hook, NULL);
	rcu_assign_pointer_nonull(nat_h245_hook, NULL);
	rcu_assign_pointer_nonull(nat_callforwarding_hook, NULL);
	rcu_assign_pointer_nonull(nat_q931_hook, NULL);
	synchronize_rcu();
}
