...
{
	rcu_assign_pointer_nonull(nf_nat_sip_hook, NULL);
	rcu_assign_pointer_nonull(nf_nat_sip_seq_adjust_hook, NULL);
	rcu_assign_pointer_nonull(nf_nat_sip_expect_hook, NULL);
	rcu_assign_pointer_nonull(nf_nat_sdp_addr_hook, NULL);
	rcu_assign_pointer_nonull(nf_nat_sdp_port_hook, NULL);
	rcu_assign_pointer_nonull(nf_nat_sdp_session_hook, NULL);
	rcu_assign_pointer_nonull(nf_nat_sdp_media_hook, NULL);
	synchronize_rcu();
}
