...
{
	rcu_assign_pointer_nonull(nf_nat_pptp_hook_expectfn, NULL);
	rcu_assign_pointer_nonull(nf_nat_pptp_hook_exp_gre, NULL);
	rcu_assign_pointer_nonull(nf_nat_pptp_hook_inbound, NULL);
	rcu_assign_pointer_nonull(nf_nat_pptp_hook_outbound, NULL);
	synchronize_rcu();
}
